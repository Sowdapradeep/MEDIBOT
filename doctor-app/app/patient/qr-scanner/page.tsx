  ...
  if (!scanned) {
    return (
      <div className="mx-auto max-w-2xl px-4 py-6">
        <Link href="/dashboard/today-appointments" className="text-sm text-green-600 hover:underline">← Dashboard</Link>
        ...
        {/* Camera Scanner */}
        <div className="mb-4 rounded-xl border-2 border-dashed border-green-300 bg-green-50 p-8 text-center">
          <div className="mx-auto w-48 h-48 rounded-lg bg-gray-900 flex items-center justify-center mb-4 relative overflow-hidden">
            <div className="absolute inset-4 border-2 border-green-400 rounded-lg" />
            <div className="absolute top-4 left-4 right-4 h-0.5 bg-green-400 animate-bounce" />
      ...
      <div className="border-b bg-white px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Link href="/dashboard/today-appointments" className="text-green-600">←</Link>
            <div>
